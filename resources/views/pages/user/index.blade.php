                    ...
                    <div class="row fullscreen align-items-center justify-content-start">
                        <div class="col-lg-5 col-md-6">
                            <div class="banner-content">
                                <h1>Electronic <br>Collection!</h1>
                                <p>Temukan koleksi elektronik terbaru untuk kebutuhan sehari-hari Anda. Mulai dari
                                    gadget, perangkat rumah, hingga aksesoris teknologi terbaru.</p>
                            </div>
                        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 text-center">
                <div class="section-title">
                    <h1>Koleksi Elektronik Terbaru</h1>
                    <p>Dapatkan berbagai perangkat elektronik terbaru dengan harga terbaik dan teknologi mutakhir.</p>
                </div>
            </div>
        </div>
        <div class="row">
                                ...
                                @if ($item->flashSales->isNotEmpty())
                                                    @foreach ($item->flashSales as $flashSale)
                                                        ...
                                                        $endTime = \Carbon\Carbon::parse($flashSale->end_time)->toIso8601String(); // Waktu akhir flash sale
                                                                        ...
                                                                        <p id="countdown-{{ $item->id }}" class="text-danger"></p>
